...
<section class ="container m-5">
    ...
    <div style="display: flex; justify-content:center; align-items:center;height:50vh">
        ...
        <input type="text" name="nome" value="{{old('nome',$registrosRedemio->nome)}}" class="form-control" id="inputNome" placeholder="Jonas">
        @error('nome')
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="convenio" value="{{old('convenio',$registrosRemedio->nome)}}" class="form-control" id="inputconvenio" placeholder="">
        @error('convenio')
    ...
    <div class="col-12">
        ...
        <input type="text" name="medicamento" value="{{old('medicamento',$registrosRemedio->nome)}}" class="form-control" id="inputmedicamento" placeholder="">
        @error('medicamento')
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="dosagem" value="{{old('dosagem',$registrosRemedio->nome)}}" class="form-control" id="inputdosagem" placeholder="">   
        @error('dosagem')
        ...
        <input type="text" name="preco" value="{{old('preco',$registrosRemedio->nome)}}" class="form-control" id="inputpreco" placeholder="">
    </div>
    @error('preco')
